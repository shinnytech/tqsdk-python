...
class TqDatetime(object):
    ...
    def _get_trading_timestamp(quote, current_datetime: str):
        ...
        trading_timestamp = {
            "day": TqDatetime._get_period_timestamp(current_trading_day_timestamp, quote["trading_time"].get("day", [])),
            "night": TqDatetime._get_period_timestamp(last_trading_day_timestamp, quote["trading_time"].get("night", []))
        }
