...
class TqApi(object):
    ...
    # ----------------------------------------------------------------------
    def insert_order(self, symbol, direction, offset, volume, limit_price=None, price_type=None,
                     time_condition=None, volume_condition=None, contingent_condition=None, order_id=None) -> Order:
        """
