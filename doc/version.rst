...
* docs: 更新 TqSdk Skills 调仓与多策略说明


3.10.0 (2026/05/26)

* 新增: :py:class:`~tqsdk.TargetPosScheduler` 支持有最小开仓手数限制的合约
* 新增: :py:class:`~tqsdk.algorithm.twap` 支持有最小开仓手数限制的合约
* 优化: 多策略支持日志导出和自动切换交易日功能，详情见 :ref:`tq_trading_unit`
* docs: 优化文档
...
* 新增: 支持 xuntou 柜台，详情参考 :py:class:`~tqsdk.TqXuntou`


3.9.6 (2026/05/12)

* 优化: 优化直连用户日志存储
* 新增: 支持通过环境变量设置评测模式，详情参考 :ref:`evaluation_trace`
