...
Trae 官网：`https://www.trae.cn/ <https://www.trae.cn/>`_
...
1. 访问 `Trae 官网 <https://www.trae.cn/>`_ 获取安装包。
...
1. **获取 TqSdk 源码**：
    * **方式一（深入研究推荐）**：从源码仓库克隆。默认可使用 GitHub 官方仓库；如果 GitHub 访问不便，也可以改用 Gitee 镜像仓库：::
        ...
        记下其中的 ``tqsdk`` 源码目录；使用 Trae 时，两者效果相同。
